...
import json
import os
import models_no_speaker as models
import datasets
import util
import denoise
...
def get_command_line_arguments():
    ...
    parser.set_defaults(config='config_no_speaker.json')
...
#加载json文件得到的是一个字典，使用的时候就直接调用字典就可以啦
...
def get_dataset(config, model):
    ...
    #just nsdtsea dataset is used here
